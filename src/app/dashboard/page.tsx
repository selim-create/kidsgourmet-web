...
export default function DashboardPage() {
  ...
  const children = [
    { 
      ...
      name: "Deniz", 
      age: "9 Aylık", 
      image: "https://placehold.co/300x300/FFF3E0/FF8A65?text=Deniz", 
      weight: "8.5 kg", 
      height: "72 cm",
      note: "9. ay gelişiminde pütürlü gıdalara alışma dönemi kritik."
    },
    { 
      id: 2, 
      name: "Ada", 
      age: "3 Yaş", 
      image: "https://placehold.co/300x300/E1BEE7/8E24AA?text=Ada", 
      weight: "14.2 kg", 
      height: "96 cm",
      note: "3 yaş sendromu ve seçici yeme dönemi. Renkli tabaklar önemli."
    }
  ];
        ...
        <main className="flex-1 w-full min-w-0">
            ...
            <div className="lg:hidden bg-white px-4 py-3 flex items-center justify-between shadow-sm sticky top-20 z-30 border-b border-gray-100">
                <div className="flex items-center gap-2">
                    <img src="https://placehold.co/100x100/FFCC80/ffffff?text=E" className="w-8 h-8 rounded-full border border-gray-100" alt="User" />
                    <span className="font-bold text-slate-800">Merhaba, Elif!</span>
                </div>
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex items-center gap-3 mb-6 overflow-x-auto hide-scroll pb-2">
                            {children.map((child) => (
                                ...
                                >
                                    <img src={child.image} className={`w-6 h-6 rounded-full border ${activeChildId === child.id ? "border-white" : "border-white/50"}`} alt={child.name} />
                                    <span className={`text-sm ${activeChildId === child.id ? "font-bold" : "font-medium"}`}>{child.name}</span>
                                </button>
                            ))}
                            
                            <button className="w-8 h-8 rounded-full bg-white/10 hover:bg-white/30 flex items-center justify-center border border-white/20 transition-all text-sm" title="Çocuk Ekle">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
                            ...
                            <div className="relative flex-shrink-0">
                                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-white/30 shadow-xl overflow-hidden bg-white transition-all duration-300">
                                    <img src={activeChild.image} className="w-full h-full object-cover" alt={activeChild.name} />
                                </div>
                            ...
                            <div className="text-center md:text-left flex-1">
                                ...
                                <div className="flex flex-wrap justify-center md:justify-start gap-3">
                                    <div className="bg-white/20 backdrop-blur px-4 py-2 rounded-xl flex items-center gap-2 text-xs md:text-sm font-bold border border-white/10">
                                        <i className="fa-solid fa-weight-scale"></i> {activeChild.weight}
                                    </div>
                                    <div className="bg-white/20 backdrop-blur px-4 py-2 rounded-xl flex items-center gap-2 text-xs md:text-sm font-bold border border-white/10">
                                        <i className="fa-solid fa-ruler-vertical"></i> {activeChild.height}
                                    </div>
                                    <button className="bg-white text-orange-500 px-4 py-2 rounded-xl text-xs md:text-sm font-bold shadow-sm hover:bg-orange-50 transition-colors">
                                        Profili Düzenle
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="bg-white p-4 rounded-3xl border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow cursor-pointer">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-400">10 dk • {activeChild.age}</p>
                            </div>
                        ...
                        <div className="bg-white p-4 rounded-3xl border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow cursor-pointer">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-400">30 dk • {activeChild.age}</p>
                            </div>
                            <div className="ml-auto w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-300 hover:bg-green-50 hover:border-green-200 hover:text-green-500 transition-all">
                                <i className="fa-solid fa-check"></i>
                            </div>
                        ...
                        <div className="bg-white p-4 rounded-3xl border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow cursor-pointer">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-400">20 dk • {activeChild.age}</p>
                            </div>
                            <div className="ml-auto w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-300 hover:bg-green-50 hover:border-green-200 hover:text-green-500 transition-all">
                                <i className="fa-solid fa-check"></i>
                            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group cursor-pointer hover:border-orange-200 transition-colors">
                        ...
                        <h3 className="font-bold text-slate-800 mb-4 flex items-center">
                            <i className="fa-solid fa-basket-shopping text-orange-500 mr-2"></i> Eksik Malzemeler
                        </h3>
                        <ul className="space-y-3 mb-4">
                            <li className="flex items-center text-sm text-gray-600">
                                <span className="w-2 h-2 bg-green-400 rounded-full mr-2"></span> Somon (200g)
                            </li>
                            <li className="flex items-center text-sm text-gray-600">
                                <span className="w-2 h-2 bg-green-400 rounded-full mr-2"></span> Avokado (1 adet)
                            </li>
                            <li className="flex items-center text-sm text-gray-600">
                                <span className="w-2 h-2 bg-green-400 rounded-full mr-2"></span> Tam Buğday Unu
                            </li>
                        </ul>
                        <button className="w-full bg-gray-50 text-gray-600 font-bold py-2 rounded-xl text-sm hover:bg-gray-100 transition-colors">
                            Listeyi Gör
                        </button>
                    </div>
                    ...
                    <div className="bg-green-50/50 p-6 rounded-3xl border border-green-100 shadow-sm relative">
                        ...
                        <p className="text-sm text-slate-700 italic mb-3">
                            "{activeChild.name} bu ay pütürlü gıdalara geçerken öğürme refleksi gösterebilir. Bu normaldir, panik yapmayın ve..."
                        </p>
