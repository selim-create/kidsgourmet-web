...
export default function StainEncyclopediaClient() {
                ...
                {isSearching ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {searchResults.map((stain) => (
                      ...
                      >
                        ...
                        <p className="text-xs text-gray-500 mb-3">{getCategoryLabel(stain.category)}</p>
                  ...
                  <div className="bg-white rounded-2xl p-8 text-center">
                    ...
                    <p className="text-sm text-gray-400 mb-6">
                      Popüler lekelerden birini deneyebilirsiniz:
                    </p>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      {popularStains.slice(0, 4).map((stain) => (
                        <button
                          key={stain.slug}
                          onClick={() => handleStainClick(stain.slug)}
                          className="px-4 py-3 bg-violet-50 text-violet-600 rounded-xl hover:bg-violet-100 transition-colors font-medium flex items-center justify-center gap-2"
                        >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-violet-50">{getCategoryLabel(selectedStain.category)}</p>
                        </div>
                      </div>
